...
from utils import deNormalize, draw_rotated_bbox, get_center
from utils import refine_angle_bisection, refine_scale_x, refine_scale_y, refine_angle
...
with torch.no_grad():
    ...
    # template = cv2.merge([tmp_gray,tmp_gray,tmp_gray])
